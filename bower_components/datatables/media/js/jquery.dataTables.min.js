...
oPaginate:{sFirst:"First",sLast:"Letzte",sNext:"Nächste",sPrevious:"Vorherige"},sEmptyTable:"No data available in table",sInfo:"Zeige _START_ bis _END_ von _TOTAL_ Einträgen",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Zeige _MENU_ Einträge",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Suche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"keine Einträge gefunden."},oSearch:h.extend({},
